...
test(encontraSequencia_6, [fail]) :- Tab = [[_, e, e], [_, p, p], [_, _, p], [p, _, _]],
                             encontraSequencia(Tab, 3, [(1,1), (2,1), (3, 1), (3,2)], Seq),
                             assertion(Seq == [(1,1),(2,1),(3,1)]).

test(encontraSequencia_7) :- Tab = [[_, e, e], [_, p, p], [_, _, p], [p, _, _]],
                             encontraSequencia(Tab, 2, [(3, 1), (3,2), (3,3)], Seq),
                             assertion(Seq == [(3, 1), (3,2)]).
